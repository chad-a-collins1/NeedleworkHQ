...
<TR><TD><P>&nbsp;</P></TD></TR>
<TR><TD><P>&nbsp;</P></TD></TR>
<TR><TD><Font Color="red"><H3><U>STEP 2:</U></Font><Font color="black">&nbsp;If your custom pattern includes a picture, please email the picture to the following email address:</Font><font color="blue"><a href="mailto:support@crossstitchconnection.com">&nbsp;support@CrossStitchConnection</a></font>
...
<TR><TD><Font Color="red"><H3><U>STEP 3:</U></Font><Font color="black">&nbsp;Please click the secure PayPal button below,  the amount of $11.99 will be do at this time. </Font></TD></TR>
<TR><TD><CENTER>
...
<input type="hidden" name="return" value="http://www.needleworkhq.com/orderComplete.htm">
<input type="hidden" name="cancel_return" value="http://www.needleworkhq.com/orderCanceled.htm">
