...
If Request.QueryString("param") = "-3"  Then
...
Response.Write "<Table><tr><td>"
	...
	Response.Write "<TR colspan=2><TD><B>PCStitch Viewer?</B><BR><SELECT" & " Name=" & """ViewerYN""" & "><OPTION VALUE=" & """0""" & " SELECTED>" & "no" & "</OPTION>" & "<OPTION VALUE=" & """1""" & ">" & "yes" & "</OPTION>" & "</SELECT></TD></TR>"	
